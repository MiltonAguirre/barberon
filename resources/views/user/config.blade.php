          ...
          <p class="subtitule">Información de usuario</p>
            <form class="form-horizontal" method="POST" action="/user/edit/{{$user->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                      <div class="col-4 {{ $errors->has('first_name') ? ' has-error' : '' }}">
                      ...
                      <div class="col-4 {{ $errors->has('last_name') ? ' has-error' : '' }}">
                ...
                <!--Email and Username -->
                <div class="form-group row">
                    <div class="col-4 {{ $errors->has('username') ? ' has-error' : '' }}">
                    ...
                    <div class="col-4 {{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <!--Ubications-->
                <div class="form-group row">
                  <div class="col-4  {{ $errors->has('location') ? ' has-error' : '' }}">
                  ...
                  <div class="col-4 {{ $errors->has('city') ? ' has-error' : '' }}">
                ...
                <div class="form-group row">
                  <div class="col-4  {{ $errors->has('addressname') ? ' has-error' : '' }}">
                  ...
                  <div class="col-4  {{ $errors->has('addressnum') ? ' has-error' : '' }}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-offset-2  {{ $errors->has('phone') ? ' has-error' : '' }}">
